...
Instead of directly scaling on the raw waveform, which leads to the pitch shifting, we encode the raw waveform as a real-valued neuralgram and scale the neuralgram. Finally, we decode the scaled neuralgram to get time-scaled audio without pitch shifting, as illustated in Figure \ref{fig:4}.
